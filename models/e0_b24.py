...
#img_quant.train()
#img_quant.save_model('./model_files/e0_b24', '')

img_quant.load_model('./model_files/e0_b24')
#img_quant.compute_encoder_mapping("./model_files/e0_b24")
img_quant.load_encoder_mapping("./model_files/e0_b24.npy")
...
plt.imsave('./images/received_fox_24bit_e0.png', uncompressed_img, cmap='gray')

psnr = 10*math.log(255**2 / img_quant.calc_distortion('./images/received_fox_24bit_e0.png', './original_fox.png'), 10)
