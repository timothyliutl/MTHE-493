...
img_quant.load_model('./model_files/e0_b58')
#img_quant.compute_encoder_mapping("./model_files/e0_b58")
img_quant.load_encoder_mapping("./model_files/e0_b58.npy")
...
plt.imsave('./images/received_fox_58bit_e0_01_channel.png', uncompressed_img, cmap='gray')

psnr = 10*math.log(255**2 / img_quant.calc_distortion('./images/received_fox_58bit_e0_01_channel.png', './original_fox.png'), 10)
